...
6. **`plans:games:variants`** — `seed-game-variant-plans.js` creates per-game modded/profile plan ids for each RAM tier we sell (typically **2 / 4 / 6 / 8 / 12 GB**, with **ARK** and **Enshrouded** starting at **6 GB**, **Palworld** / **Among Us** profiles at **4 GB** and up). Legacy vanilla plan ids are deactivated at the end of the seed.
