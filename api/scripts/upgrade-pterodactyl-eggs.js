...
if unzip -tq /tmp/impostor.pkg >/dev/null 2>&1; then
  ...
  tar -xzf /tmp/impostor.pkg -C /mnt/server
    ...
    variables: [
      ...
      [
        'Impostor Public IP',
        'Hostname or IPv4 clients use to reach this server (leave empty to use allocation alias/IP from provisioner, or set GAME_SERVER_PUBLIC_HOST on the API)',
        'IMPOSTOR_Server__PublicIp',
        '',
        1,
        1,
      ...
      [
        'Impostor Public Port',
        'UDP port advertised to clients (usually primary game port; provisioner sets from allocation)',
        'IMPOSTOR_Server__PublicPort',
        '',
        1,
        1,
        'nullable|numeric',
