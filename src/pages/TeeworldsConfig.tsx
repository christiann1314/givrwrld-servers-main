...
const TeeworldsConfig = () => {
  ...
  const fallbackPlans = [
    { id: 'teeworlds-1gb', name: '1GB', ram: '1GB', cpu: '1 vCPU', disk: '10GB SSD', price: 2.49, players: '8-16', description: 'Small 2D multiplayer servers, 8-16 players' },
    { id: 'teeworlds-2gb', name: '2GB', ram: '2GB', cpu: '1 vCPU', disk: '20GB SSD', price: 3.99, players: '16-32', description: 'Medium 2D multiplayer servers, 16-32 players', recommended: true },
    { id: 'teeworlds-4gb', name: '4GB', ram: '4GB', cpu: '2 vCPU', disk: '40GB SSD', price: 6.99, players: '32-64', description: 'Large 2D multiplayer servers, 32-64 players' }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white relative overflow-hidden">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: `url(${teeworldsBackdrop})`,
      ...
      <div className="relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-green-500 text-white px-6 py-3 rounded-lg mb-8 inline-block">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {billingTerms.map((term) => (
                    ...
                    >
                      ...
                      {term.discount > 0 && (
                        <div className="text-xs text-green-300">Save {term.discount}%</div>
                      )}
                    </button>
                  ))}
                </div>
              ...
              <div className="bg-gray-800/60 backdrop-blur-md border border-gray-600/50 rounded-xl p-6 sticky top-8">
                ...
                <div className="border-t border-gray-600 pt-4 mb-6">
                  ...
                  {selectedTerm?.id !== 'monthly' && savings > 0 && (
                    <div className="text-sm text-green-300 text-right mt-1">
