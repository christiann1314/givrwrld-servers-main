...
const GAME_DISPLAY: Record<string, Partial<DeployCard>> = {
  minecraft: {
    ...
    features: ['Plugin & mod support', 'Paper, Fabric, Forge, Purpur, and more', 'Ryzen 9 5900X', 'Java & Bedrock'],
  ...
  enshrouded: {
    ...
    features: ['Up to 16 players', 'Mod-ready Enshrouded profiles', 'Ryzen 9 5900X', 'Fast deployment'],
    buttonColor: 'bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-400 hover:to-orange-500',
