...
const AmongUsConfig = () => {
  ...
  const fallbackPlans = [
    { id: 'among-us-1gb', name: '1GB', ram: '1GB', cpu: '1 vCPU', disk: '10GB SSD', price: 1.99, players: '4-10', description: 'Small social deduction servers, 4-10 players' },
    { id: 'among-us-2gb', name: '2GB', ram: '2GB', cpu: '1 vCPU', disk: '20GB SSD', price: 2.99, players: '10-15', description: 'Medium social deduction servers, 10-15 players', recommended: true },
    { id: 'among-us-4gb', name: '4GB', ram: '4GB', cpu: '2 vCPU', disk: '40GB SSD', price: 4.99, players: '15+', description: 'Large social deduction servers, 15+ players' }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white relative overflow-hidden">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: `url(${amongUsBackdrop})`,
